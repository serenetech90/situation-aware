...
class DataLoader():
    ...
    def __init__(self, batch_size=50, seq_length=5, datasets=[0, 1, 2, 3, 4], forcePreProcess=False, infer=False):
        ...
        #/home/serene/PycharmProjects/srnn-pytorch-master/data/eth/hotel/HEWEI
        self.data_dirs = ['./data/eth/univ/HEWEI', './data/eth/hotel/HEWEI',
                          './data/ucy/zara/zara01/HEWEI', './data/ucy/zara/zara02/HEWEI',
                          './data/ucy/univ/HEWEI']

        # self.data_dirs = ['./12' , './13' , './15' , './19']

        # self.data_dirs = ['./0' , './1', './2', './3']
        # self.data_dirs = ['./data/eth/univ/HEWEI',
        #                   './data/eth/hotel/HEWEI',
        #                   './data/ucy/zara/zara01/HEWEI',
        #                   './data/ucy/zara/zara02/HEWEI',
        #                   './data/ucy/univ/HEWEI']

        # self.data_dirs = ['/home/serene/Documents/InVehicleCamera/KITTI-13/gt']

        self.used_data_dirs = [self.data_dirs[x] for x in datasets]
        self.test_data_dirs = [self.data_dirs[x] for x in range(4) if x not in datasets]
        self.infer = infer
        ...
        self.data_dir = './data' #'/home/serene/Documents/InVehicleCamera/KITTI-13/gt'
    ...
    def frame_preprocess(self, data_dirs, data_file):
        ...
        for ind_directory, directory in enumerate(data_dirs):
            ...
            file_path = os.path.join(directory, 'pixel_coordinate_inter_normalized01.csv') # world_coordinate_inter_normalized.csv  'gt.csv' / pixel_coordinate_inter_normalized01.csv

            #/home/siri0005/srnn-pytorch-master/data/eth/univ/HEWEI/pixel_coordinate_inter_normalized.csv
    ...
    def next_batch(self, randomUpdate=True):
        ...
        return x_batch, y_batch, frame_batch, self.dataset_pointer
    ...
    def next_valid_batch(self, randomUpdate=True):
        ...
        return x_batch, y_batch, self.valid_dataset_pointer
