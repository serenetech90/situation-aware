...
def Gaussian2DLikelihood(outputs, targets, nodesPresent, pred_length):
    ...
    # July 16th: add new linear layer of outputs to achieve global consistency
	...
	counter = 0
        ...
        for nodeID in nodeIDs:
            cNode = nodeID
            # result[framenum , nodeID] = np.linalg.norm(result[framenum , nodeID] , np.select([nodeID != cNode]) , p=2 , axis=1)
